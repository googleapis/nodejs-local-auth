...
Samples are in the [`samples/`](https://github.com/googleapis/nodejs-local-auth/tree/main/packages/google-cloud-functions/samples) directory. Each sample's `README.md` has instructions for running its sample.
